...
.progress-icon { background: #e8f4fd; color: #409eff; }
.correct-icon { background: #e8f9ee; color: #67c23a; }
.wrong-icon { background: #fef0f0; color: #f56c6c; }
.accuracy-icon { background: #fdf6ec; color: #e6a23c; }
