...
class Favorite(db.Model):
    ...
    def __repr__(self):
        return f" favorite's info: favoriteid = {self.favoriteid}, articleid = {self.articleid} , userid = {self.userid},  \
               canceled = {self.canceled}, createtime = {self.createtime},updatetime = {self.updatetime}"
...
class Credit(db.Model):
    ...
    def __repr__(self):
        return f" credit's info: creditid = {self.creditid}, category = {self.category} , userid = {self.userid},  \
               target = {self.target}, credit = {self.credit}, createtime = {self.createtime},updatetime = {self.updatetime}"
