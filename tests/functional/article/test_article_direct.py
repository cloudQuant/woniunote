...
使用Flask测试客户端直接测试文章模块功能，不依赖网络连接
"""
...
if __name__ == "__main__":
    # 直接运行测试
    print("请使用pytest运行测试： python -m pytest tests/functional/article/test_article_direct.py -v")
